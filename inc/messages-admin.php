...
function hdh_get_default_messages() {
    return array(
        ...
        'verification' => array(
            ...
            'code_length_error' => 'Lütfen 6 haneli doğrulama kodunu girin.',
            ...
            'firebase_email_sent' => 'Doğrulama e-postası gönderildi. E-posta kutunuzu kontrol edin.',
            'firebase_email_send_failed' => 'E-posta gönderilemedi. Lütfen tekrar deneyin.',
            'firebase_email_not_verified' => 'E-posta henüz doğrulanmamış. Lütfen e-posta kutunuzu kontrol edin.',
        ),
        'ui' => array(
            'loading' => 'Yükleniyor...',
            'saving' => 'Kaydediliyor...',
        ...
        'ajax' => array(
            ...
            'no_email' => 'Kullanıcının e-posta adresi bulunamadı',
            'already_verified' => 'E-posta zaten doğrulanmış',
            'rate_limit' => 'Çok fazla deneme. Lütfen 1 saat sonra tekrar deneyin.',
            'send_failed' => 'E-posta gönderilemedi. Lütfen daha sonra tekrar deneyin.',
            'code_expired' => 'Doğrulama kodu süresi dolmuş. Lütfen yeni kod isteyin.',
            'invalid_code' => 'Doğrulama kodu hatalı',
            'phone_verification_disabled' => 'Telefon doğrulaması devre dışı bırakılmıştır.',
            'insufficient_balance' => 'Yetersiz jeton',
            'already_claimed' => 'Bu görevin ödülü zaten alınmış',
            'not_completed' => 'Görev henüz tamamlanmamış',
