...
function hdh_get_default_content($page) {
    $defaults = array(
        ...
        'profile' => array(
            ...
            'deactivate_listing_confirm' => 'Bu ilanı kaldırmak istediğinize emin misiniz? Kaldırılan ilanlar tekrar aktif edilemez.',
            'listing_deactivated_success' => 'İlan başarıyla kaldırıldı.',
            'listing_status_inactive' => '⏸️ Pasif',
            'deactivate_button_text' => '🗑️ İlanı Kaldır',
